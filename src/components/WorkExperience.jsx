  ...
  return (
    <section className="bg-[var(--accent-dark)] py-20 px-6 md:px-16" id='work-experience'>
      ...
      >
        ...
        <motion.p
          variants={fadeUp}
          className="mb-12 text-white max-w-xl"
        >
        ...
        >
          ...
          (
            <motion.div
              ...
              className='bg-[var(--accent-primary)] group relative text-white p-8 rounded-3xl'
            >
              <div className="text-black group-hover:scale-110 text-6xl md:absolute right-5 top-5 transition-all duration-300 bg-gradient-to-r hover:bg-gradient-to-l from-[var(--accent-gradient1)] to-[var(--accent-gradient2)] text-[var(--accent-dark)] p-5 inline-block rounded-full">
                <BsBuildings />
              </div>
              <div>
